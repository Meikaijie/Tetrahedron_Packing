...
;; SOURCE: https://gist.github.com/postspectacular/9021724
...
;; Uncomment to accept user input when running file
; (def a 
;   (into []
;     (for [x (vec *command-line-args*)]
;     (read-string x))
;   )
; )
